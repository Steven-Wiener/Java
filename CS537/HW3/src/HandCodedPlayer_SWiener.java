...
public class HandCodedPlayer_SWiener extends NannonPlayer {

	/** 
	 * You should rename this file to:  HandCodedPlayer_yourLoginName.java
	 * 
	 */
	public HandCodedPlayer_SWiener() {
	}

	public HandCodedPlayer_SWiener(NannonGameBoard gameBoard) {
		super(gameBoard);
	}
	@Override
